    ...
    <div className="min-h-screen bg-gradient-to-b from-[#e0d8d0] to-[#d0c8c0] p-4 flex flex-col items-center justify-center font-sans text-retro-dark select-none">
      ...
      ">
        ...
        <div className="w-full h-full bg-gradient-to-br from-[#F8EED8] via-[#F4E4BC] to-[#E8D8A8] rounded-[36px] p-5 flex flex-col gap-5 relative overflow-hidden">
          ...
          <div className="flex-1 flex items-center justify-center p-1 bg-gradient-to-b from-[#e0d6c6] to-[#d0c6b6] rounded-xl shadow-[inset_0_2px_6px_rgba(0,0,0,0.1),0_1px_0_rgba(255,255,255,0.5)] border border-white/40 relative z-10 overflow-hidden">
            ...
            <div className="w-[525px] h-[328px] flex items-center justify-center transform rotate-90 scale-[1.1] filter drop-shadow-[0_4px_12px_rgba(0,0,0,0.15)]">

...
export const Cassette = ({ isPlaying, progress = 0 }: CassetteProps) => {
    ...
    return (
        <div className="h-full aspect-[1/1.6] bg-[#1a1a1a] rounded-lg p-1.5 shadow-2xl relative overflow-hidden">
            ...
            {/* Main Body Plastic */}
            <div className="w-full h-full bg-gradient-to-br from-[#EDE5D5] via-[#E3DAC9] to-[#D8CFBF] rounded-[4px] relative overflow-hidden shadow-inner">
                ...
                {/* Left Area (Tape Head / Trapezoid Area) */}
                <div className="absolute left-0 top-0 bottom-0 w-[18%] bg-gradient-to-r from-[#c5baaa] to-[#d4c9b9] shadow-[1px_0_3px_rgba(0,0,0,0.15)] flex flex-col items-center justify-center gap-12 z-10">
                     <div className="absolute inset-0 bg-plastic-texture opacity-10 pointer-events-none" />
                     <GuideHole />
                     <div className="w-3 h-10 bg-[#2a2a2a] rounded-sm shadow-[inset_1px_0_3px_rgba(0,0,0,0.5)]" />
                     <GuideHole />
                </div>

                {/* Window Area - Centered vertically in the middle section */}
                <div className="absolute left-[24%] right-[28%] top-[10%] bottom-[10%] bg-[#1a1a1a] rounded-xl shadow-[inset_0_2px_8px_rgba(0,0,0,0.8)] border border-[#333] overflow-hidden flex flex-col items-center justify-center gap-10 py-6 z-10">
                     {/* Window Depth Layer */}
                ...
                {/* Label Strip - On the right side */}
                <div className="absolute right-[5%] top-[8%] bottom-[8%] w-[18%] bg-[#FDFCF5] rounded-sm shadow-md overflow-hidden flex items-center justify-center z-10 border border-black/5">
                    ...
                    <div className="absolute bottom-0 w-full h-8 bg-retro-secondary/80 mix-blend-multiply" />

                    {/* Handwritten Label - Rotated Vertical */}
                    <div
                        className="text-[#1a1a1a] text-[15px] transform rotate-90 whitespace-nowrap"
                        style={{

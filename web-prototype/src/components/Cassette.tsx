...
export const Cassette = ({ isPlaying, progress = 0 }: CassetteProps) => {
    ...
    return (
        <div className="w-full aspect-[1.6/1] bg-gradient-to-br from-[#9BA892] via-[#7F8C76] to-[#65705B] rounded-lg relative overflow-hidden shadow-2xl flex flex-col items-center">
            ...
            {/* Label Area (Paper Texture) - Lower layer (z-10) */}
            <div className="w-[88%] h-[62%] mt-3.5 bg-[#FDFCF5] rounded-sm shadow-md relative overflow-hidden transform rotate-[0.2deg] z-10">
            ...
            {/* Window Area (Magnetic Tape & Reels) - Higher layer (z-20) */}
            {/* Centered on the label area */}
            <div className="absolute top-[34%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[65%] h-[27%] bg-[#1a1a1a] rounded-xl shadow-[inset_0_2px_8px_rgba(0,0,0,0.8),inset_0_-1px_2px_rgba(255,255,255,0.1)] flex items-center justify-center gap-5 px-3 border border-[#333] z-20 overflow-hidden">
                {/* Window Depth Layer */}

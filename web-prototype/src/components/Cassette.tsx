    ...
    return (
        <div className="w-full aspect-[1.6/1] bg-gradient-to-br from-[#9BA892] via-[#7F8C76] to-[#65705B] rounded-lg relative overflow-hidden shadow-2xl flex flex-col items-center">
            ...
            <div className="w-[88%] h-[62%] mt-3.5 bg-[#FDFCF5] rounded-sm shadow-md relative overflow-hidden transform rotate-[0.2deg]">
                ...
                {/* Window Cutout */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[38%] w-[74%] h-[44%] bg-[#1a1a1a] rounded-xl shadow-[inset_0_2px_8px_rgba(0,0,0,0.8),inset_0_-1px_2px_rgba(255,255,255,0.1)] flex items-center justify-center gap-1 px-3 border border-[#333]">
                    {/* Window Depth Layer */}

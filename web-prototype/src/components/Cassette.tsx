...
export const Cassette = ({ isPlaying, progress = 0 }: CassetteProps) => {
    ...
    return (
        <div className="w-full aspect-[1.6/1] bg-gradient-to-br from-[#F5F0E6] via-[#EBE2D5] to-[#DED5C0] rounded-lg relative overflow-hidden shadow-2xl flex flex-col items-center">
            ...
            <div className="absolute bottom-0 w-[68%] h-[22%] bg-gradient-to-b from-[#EBE2D5] to-[#DED5C0] clip-path-trapezoid flex items-center justify-center gap-10 shadow-[0_-2px_6px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.4)] border-t border-black/5">
                {/* Surface texture */}
...
const Screw = ({ className }: { className: string }) => (
    <div className={`absolute w-3 h-3 rounded-full bg-gradient-to-br from-[#d0c8b8] via-[#b8b0a0] to-[#a09888] shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.5)] flex items-center justify-center ${className}`}>
        <div className="w-2 h-2 rounded-full bg-gradient-to-br from-[#b8b0a0] to-[#d0c8b8] shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)] flex items-center justify-center">
            <div className="absolute w-[1px] h-1.5 bg-[#7a7060] rotate-45 shadow-[0_0_1px_rgba(0,0,0,0.3)]" />
            <div className="absolute w-[1px] h-1.5 bg-[#7a7060] -rotate-45 shadow-[0_0_1px_rgba(0,0,0,0.3)]" />
        </div>
    </div>
)
